    ...
    : IScene
{
    ...
    public void Setup( GraphicsContext graphics, Model model )
    {
        ...
        // bumpmap shader
        shaderBumpMap = new ShaderProgram( "/Application/Sample/Graphics/ShaderCatalogSample/shaders/BumpMap.cgx" );
        ...
        texNormalMap = new Texture2D( "/Application/Sample/Graphics/ShaderCatalogSample/data/normal01.png", false );
