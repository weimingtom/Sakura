    ...
    : IScene
{
    ...
    public void Setup( GraphicsContext graphics, Model model )
    {
        ...
        shaderGlossMap = new ShaderProgram( "/Application/Sample/Graphics/ShaderCatalogSample/shaders/GlossMap.cgx" );
        ...
        glossmap = new Texture2D( "/Application/Sample/Graphics/ShaderCatalogSample/data/glossmap.png", false );
