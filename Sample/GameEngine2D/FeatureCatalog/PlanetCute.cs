...
namespace FeatureCatalogPlanetCute
{
	...
	public class PlanetCute
		...
		, System.IDisposable
	{
		public TextureInfo ObjectsMap = new TextureInfo( new Texture2D( "/Application/Sample/GameEngine2D/FeatureCatalog/data/PlanetCute/Objects.png", false ), new Vector2i(7,3) );
		public TextureInfo ShadowsMap = new TextureInfo( new Texture2D( "/Application/Sample/GameEngine2D/FeatureCatalog/data/PlanetCute/Shadows.png", false ), new Vector2i(3,3) );
		public TextureInfo BlocksMap = new TextureInfo( new Texture2D( "/Application/Sample/GameEngine2D/FeatureCatalog/data/PlanetCute/Blocks.png", false ), new Vector2i(5,5) );
