...
*/
		 ...
		 */
		private Sce.Pss.Core.Vector2 myPosition		= new Sce.Pss.Core.Vector2(128, 256);
		public	Sce.Pss.Core.Vector2 MyPosition
		{
		...
		public Sce.Pss.Core.Vector2 networkPosition	= new Sce.Pss.Core.Vector2(256, 256);
		public Sce.Pss.Core.Vector2 NetworkPosition
		{
...
//						Log.Write("Accept " + ClientSocket.RemoteEndPoint.ToString() + "\n");
						IsConnect = true;
					}
				}
				finally
...
//						Log.Write("Connect " + Socket.RemoteEndPoint.ToString() + "\n");
						IsConnect = true;
					}
				}
				finally
...
//					Log.Write("ReceiveCallback 切断検出\n");
					Disconnect();
				}
			}
			catch (Exception e)
